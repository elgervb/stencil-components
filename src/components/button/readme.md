...
| `type`     | `type`     | The type of the button, leave empty in case of a link | `"button" \| "icon" \| "link" \| "reset" \| "submit"` | `'button'`  |
...
| ---------- | ----------- | ------------------- |
| `evbBlur`  | Blur event  | `CustomEvent<void>` |
| `evbFocus` | Focus event | `CustomEvent<void>` |
